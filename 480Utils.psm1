function Connect-480VCenter {
    <#
    .SYNOPSIS
    Connects to the 480 vCenter server
    #>
    param(
        [string]$Server = "vcenter.dylan.local",
        [string]$User = "dylan-adm@dylan.local",
        [string]$Password = "Towerhill0!"
    )
    ...
    try {
        ...
        Write-Host "Could not connect to vCenter at $Server" -ForegroundColor Red
